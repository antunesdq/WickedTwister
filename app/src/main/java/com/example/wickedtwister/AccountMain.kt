...
class AccountMain : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        usr= args.userMain
        acc= Account(accId = args.accountMain)
        acc.get()
    }
    override fun onCreateView(
        ...
        val pieChartTextView: TextView = view.findViewById(R.id.main_account_pie_chart_total_value)

        val pieChartSecondaryTextView: TextView = view.findViewById(R.id.main_account_pie_chart_budget_value)

        val pieChartTra: PieChart = view.findViewById(R.id.main_account_pie_chart)

        val pieChartBud: PieChart = view.findViewById(R.id.main_account_pie_chart_bud)

        val transactionRecyclerView:RecyclerView = view.findViewById(R.id.main_account_recycler_view)
        ...
        settingsLocation.text = "Account Dashboard - ${acc.accAlias}"
        ...
        createPieChart(
            ...
            MapTra = acc.serialTra,
            MapBud = acc.serialBud)

        val accs = mutableMapOf<String, Account>()
        accs[acc.accId] = acc

        createRecyclerView(transactionRecyclerView, acc.transactions, accs)
